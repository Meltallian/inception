...
#wp plugin install redis-cache --activate --allow-root #for performance

#C'est ici qu'on modifie le .conf de wordpress pour ecouter le port 9000 comme demande dans la donnee.
